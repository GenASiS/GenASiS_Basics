program ParametersStream_Form_Test

  use VariableManagement
  use Display
  use MessagePassing
  use ParametersStream_Form
  ...
  character ( LDL ), dimension ( 10 ) :: & 
    ...
    StringArray_3 = ''
  character ( LDF ) :: &
   Filename = 'ParametersStream_Form_Test_Parameters'
  type ( CommunicatorForm ), allocatable :: &
    C
  type ( ParametersStreamForm ) :: &
    PS
...
end program ParametersStream_Form_Test
